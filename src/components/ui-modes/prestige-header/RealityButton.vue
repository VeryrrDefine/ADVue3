...
export default {
    ...
    methods: {
        ...
        update() {
            ...
            this.projectedRM = Currency.realityMachines.cappedGain
                .times(multiplier)
                .clampMax(Currency.realityMachines.hardcap)
            this.newIMCap = Currency.imaginaryMachines.projCap
            this.machinesGained = this.projectedRM.clampMax(
                Currency.realityMachines.hardcap.sub(Currency.realityMachines.cappedGain),
            )
            ...
            this.currentShardsRate.copyFrom(
                this.shardsGained.div(Time.thisRealityRealTime.totalMinutes),
            )
            ...
            const teresaReward = this.formatScalingMultiplierText(
                ...
                Decimal.max(
                    Teresa.runRewardMultiplier,
                    Teresa.rewardMultiplier(Currency.antimatter.value),
                ),
            )
        ...
        hasSpecialReward() {
            ...
            return (
                ...
                ((Effarig.isRunning && !EffarigUnlock.reality.isUnlocked) ||
                    (Enslaved.isRunning && !Enslaved.isCompleted))
            )
        },
    },
}
            ...
            <div class="l-reality-button__contents">
                ...
                <div v-if="canReality" class="infotooltiptext">
                    ...
                    <div v-if="shardsGained.neq(0)">
                        ...
                        <br />
                        Peak: {{ format(bestShardRate, 2) }}/min at
                        {{ format(bestShardRateVal, 2) }} RS
                    </div>
